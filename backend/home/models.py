...
class CustomText(models.Model):
    ...
    jkhkjhkjhk = models.ForeignKey(
        "home.HomePage",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
        related_name="customtext_jkhkjhkjhk",
    )
    hjgjfhgjgh = models.ManyToManyField(
        "users.User",
        blank=True,
        related_name="customtext_hjgjfhgjgh",
    )
...
class Ghgjhg(models.Model):
    ...
    nhgnhgfhjg = models.BigIntegerField(
        null=True,
        blank=True,
    )
