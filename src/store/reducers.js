...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_GHGJHG_LIST:
    case types.API_V1_GHGJHG_LIST_SUCCEEDED:
    case types.API_V1_GHGJHG_LIST_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_GHGJHG_CREATE:
    case types.API_V1_GHGJHG_CREATE_SUCCEEDED:
    case types.API_V1_GHGJHG_CREATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_GHGJHG_READ:
    case types.API_V1_GHGJHG_READ_SUCCEEDED:
    case types.API_V1_GHGJHG_READ_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_GHGJHG_UPDATE:
    case types.API_V1_GHGJHG_UPDATE_SUCCEEDED:
    case types.API_V1_GHGJHG_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_GHGJHG_PARTIAL_UPDATE:
    case types.API_V1_GHGJHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GHGJHG_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_GHGJHG_DELETE:
    case types.API_V1_GHGJHG_DELETE_SUCCEEDED:
    case types.API_V1_GHGJHG_DELETE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
